	...
	(
  	...
  	(
		:init 
			...
			(= (burnt-val butter) 0)(= (burnt-val sugar) 1)(= (burnt-val eggs) 1)(= (burnt-val vanilla) 1)(= (burnt-val cocoa) 1)(= (burnt-val flour) 1)(= (burnt-val salt) 1)(= (burnt-val baking_powder) 1)
	)
	...
	(
		...
		(
			...
			(< (burnt-val butter) 3)(< (burnt-val sugar) 3)(< (burnt-val eggs) 3)(< (burnt-val vanilla) 3)(< (burnt-val cocoa) 3)(< (burnt-val flour) 3)(< (burnt-val salt) 3)(< (burnt-val baking_powder) 3)
		)
	)
)
