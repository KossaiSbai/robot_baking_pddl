(
	...
	(
  	...
  	(
		:init 
			(MIX-CONTAINER bowl_mixing)
			(IN-SPACE bowl_butter counter)(IN-SPACE bowl_sugar counter)(IN-SPACE bowl_eggs counter)(IN-SPACE bowl_vanilla counter)(IN-SPACE bowl_cocoa counter)(IN-SPACE bowl_flour counter)(IN-SPACE bowl_salt counter)(IN-SPACE bowl_baking_powder counter)(IN-SPACE baking_sheet counter)(IN-SPACE bowl_mixing counter)
	...
	(
		...
		(
			...
			(MIXED butter) (MIXED sugar) (MIXED eggs) (MIXED vanilla) (MIXED cocoa) (MIXED flour) (MIXED salt) (MIXED baking_powder)
		)
	)
)
